...
namespace CMIS.Migrations
{
    ...
    [Migration("20260519210846_RemoveLevelFromBudgetAllocation")]
    partial class RemoveLevelFromBudgetAllocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMIS.Models.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("CMIS.Models.FinancialExpense", b =>
                {
            ...
            modelBuilder.Entity("CMIS.Models.FinancialIncome", b =>
                {
                    ...
                    b.ToTable("financial_income", (string)null);
                });
            ...
            modelBuilder.Entity("CMIS.Models.RecordSummary", b =>
                {
                    ...
                    b.Property<string>("SummaryPeriod")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)")
                        .HasColumnName("summary_period");
                    ...
                    b.ToTable("record_summary", (string)null);
                });

            modelBuilder.Entity("CMIS.Models.RecurringTithe", b =>
                {
                    ...
                    b.ToTable("recurring_tithes", (string)null);
                });
            ...
            modelBuilder.Entity("CMIS.Models.AuditLog", b =>
                {
                    b.HasOne("CMIS.Models.Profile", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CMIS.Models.FinancialExpense", b =>
                {
                    b.HasOne("CMIS.Models.Profile", "Recorder")
                        .WithMany()
            ...
            modelBuilder.Entity("CMIS.Models.FinancialIncome", b =>
                {
                    b.HasOne("CMIS.Models.Profile", "Member")
                        .WithMany()
            ...
            modelBuilder.Entity("CMIS.Models.RecordSummary", b =>
                {
                    b.HasOne("CMIS.Models.Profile", "Generator")
                        .WithMany()
            ...
            modelBuilder.Entity("CMIS.Models.RecurringTithe", b =>
                {
                    b.HasOne("CMIS.Models.Profile", "Creator")
                        .WithMany()
